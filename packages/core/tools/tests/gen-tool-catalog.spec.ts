...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'delete_memory', 'edit', 'exit_plan_mode', 'followup_task',
      'get_goal', 'glob', 'grep',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output',
      'list_agents', 'list_agents', 'lsp', 'pwsh', 'pwsh', 'ralph',
      'read', 'read_image', 'report', 'run_code', 'save_memory', 'save_session_override',
      ...
      'update_goal', 'update_memory', 'wait_agent', 'web_fetch', 'web_search', 'workflow', 'write',
    ])
